/**
 * Copyright (c) 2013 James DeFilippo
 * 
 * License:
...
/**
 * App of the Week page 
 */
qx.Class.define("aiagallery.module.dgallery.appoftheweek.Appoftheweek",
{
  type : "singleton",
  ...
  members :
  {
    ...
    initialAppear : function(module)
    {
      ...
      aiagallery.module.dgallery.appoftheweek.Fsm.getInstance().buildFsm(module);

      // Create the real gui.
      aiagallery.module.dgallery.appoftheweek.Gui.getInstance().buildGui(module);
    }
  }
});
