...
qx.Class.define("aiagallery.module.dgallery.contest.Gui",
{
  ...
  members :
  {
	...
	var widget = new qx.ui.basic.Label("App of the Week");
	widget.setFont(font);
	...
	var second = new qx.ui.basic.Image("testpage4/test.png");
        var third = new qx.ui.form.TextArea("");
        third.set({ value: "Ever have a burning desire to know how many Japanese yen go into $2.25 American dollar? There’s an app for that. You do need to look up the exchange rate, but once you have that down, you can figure the value of of any major currency to your heart’s content.", wrap: true, readOnly: true});
	...
	var second = new qx.ui.basic.Image("testpage4/test.png");
        var third = new qx.ui.form.TextArea("");
        third.set({ value: "The title says it all. The app gives you a daily snapshot of the universe. And if you want to share your astonishment with your friends, you can post the image to Twitter on your behalf. This is a prime example of software which links together different parts of the web to add to the user experience.", wrap: true, readOnly: true});
